...
def parse_lineinfo(tabels,dflist2):
...
def line_pdfextract(filename,dflist1,dflist2):
...
def main():
    filename="A:/Github Repos/UPS-project/SamplePDFs/2304 Lines.pdf"
    trips=[]
    lines=[]
    lineinfo=[]
    line_pdfextract(filename,lines,lineinfo)
